 ...
 * @asset(qx/icon/Tango/*)
 */
qx.Class.define("multicolumntree.test.DemoTreeController", {
	...
	members : {
		main : function() {
			...
			var ctlr = new multicolumntree.controller.Controller(null);
			ctlr.setOptions({
			...
			var tree = new multicolumntree.Tree().set({ 
				view: new multicolumntree.SimpleView("name", "icon"),
				showChecked: true,
				model: ctlr,
				decorator: "main",
				width: 200
