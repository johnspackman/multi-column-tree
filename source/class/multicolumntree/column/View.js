...
qx.Class.define("multicolumntree.column.View", {
  extend: qx.core.Object,
  implement: [ multicolumntree.IView ],
  ...
  properties: {
    ...
    */
    ...
    layoutClass: {
      init: multicolumntree.RowLayout
    }
  },
  ...
  members: {
    ...
    createDropCaretRow: function(tree) {
      return new multicolumntree.column.DropCaretRow(tree).set({ controller: this });
    },
