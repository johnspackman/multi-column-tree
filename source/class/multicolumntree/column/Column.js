...
qx.Class.define("multicolumntree.column.Column", {
  ...
  members: {
    ...
    getRawValue: function(model) {
      ...
      if (!path || !model)
        return null;
      return multicolumntree.Utils.getValue(model, path);
    },
    ...
    setRawValue: function(model, value) {
      ...
      if (!path || !model)
        return;
      return multicolumntree.Utils.setValue(model, path, value);
    },
    ...
    createBindings: function() {
      if (!this.getValuePath())
        return null;
      var binding = new multicolumntree.Binding(this.getValuePath(), null, true);
      return [ binding ];
    },
