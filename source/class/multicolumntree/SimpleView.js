...
qx.Class.define("multicolumntree.SimpleView", {
	extend: multicolumntree.column.View,
	
	construct: function(labelPath, iconPath) {
		this.base(arguments);
    this.__column = new multicolumntree.column.AtomColumn().set({ editable: false, width: "*" });
