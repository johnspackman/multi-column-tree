...
/**
 * Provides a layout for rows in a tree with columns
 */
qx.Class.define("johnspackman.multicolumntree.RowLayout", {
  ...
  members: {
    ...
    renderLayout : function(availWidth, availHeight, padding) {
      ...
      for (var i = 0, columns = ctlr.getColumns(); i < columns.getLength(); i++) {
